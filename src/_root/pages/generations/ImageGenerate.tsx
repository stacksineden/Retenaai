...
import { credit_charge, ratios } from "@/modelDataset";
...
const ImageGenerate = () => {
  ...
  const { trainingUrl } = useAppContext();
  ...
  async function onSubmit(values: z.infer<typeof GenerateImageSchema>) {
    ...
    //replace this with a helper class from replicate ==> user training url
