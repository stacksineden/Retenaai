    ...
    <WebLayoutWrapper>
      <section className="bg-accent">
        <AcademyHero
          ...
          description="We train Africa&#8217;s next generation of Generative AI engineers, consultants, and builders through hands-on learning, real-world projects, and career pathways that turn skills into income."
      ...
      <section
        id="faqs"
        className="w-full bg-black py-20 px-6 md:px-12 lg:px-24"
      >
