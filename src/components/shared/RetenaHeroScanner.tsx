      ...
      <section className="relative w-full min-h-[70svh] md:min-h-[100svh] bg-black overflow-hidden flex items-center justify-center">
        {isMobile !== null && (
          <>
            {isMobile ? (
              <div
                className="absolute inset-0 grid grid-cols-2 gap-2 px-2"
                aria-hidden="true"
              >
                <ScrollCol
                  items={[...COL1, ...COL3]}
        ...
        <div className="relative z-20 flex flex-col items-center text-center px-4 sm:px-6 w-full max-w-4xl mx-auto py-12">
          {/* ── BADGE — updated: removed "Fashion", now speaks to all DTC brands ── */}
          <div
          ...
          {/* ── HEADLINE — unchanged, strong as-is ── */}
          <h1
            className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white leading-tight mb-4"
          ...
          {/* ── SUBTEXT — updated: adds CPA + Meta angle, speaks to all DTC verticals ── */}
          <p
            className="text-[#E5E5E5]/90 text-sm md:text-xl max-w-xl leading-relaxed mb-8"
            style={{ animation: "fadeUp 0.7s ease 0.25s both" }}
          >
            We turn a single product photo into scroll-stopping{" "}
            <span className="text-white font-semibold">video ads</span> — built
            to lower your CPA and scale your Meta spend. Delivered in{" "}
            <span className="text-[#FCA311] font-semibold">48 hours</span>.
          </p>

          {/* ── CTAs — updated: primary now says "See What We Build", secondary unchanged ── */}
          <div
            className="flex flex-col w-full sm:w-auto sm:flex-row items-center gap-3 md:gap-4"
          ...
          >
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10 opacity-70">
              ...
              <div className="flex items-center gap-2 group">
                <svg
                  viewBox="0 0 24 24"
                  className="w-5 h-5 md:w-6 md:h-6 fill-white group-hover:fill-[#0668E1] transition-colors"
                >
                ...
                <span className="text-white/80 font-semibold text-sm md:text-base hidden sm:block">
                  Meta
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 group">
                <svg
                  viewBox="0 0 24 24"
                  className="w-5 h-5 md:w-6 md:h-6 fill-white group-hover:fill-[#FF0050] transition-colors"
                >
              ...
              <div className="flex items-center gap-2 group">
                <svg
                  viewBox="0 0 24 24"
                  className="w-5 h-5 md:w-6 md:h-6 fill-white group-hover:fill-[#E1306C] transition-colors"
                >
