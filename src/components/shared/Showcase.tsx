...
// ── ASSETS ──────────────────────────────────────────────────────────────────
const INPUT_IMAGE =
  "https://res.cloudinary.com/dast35q6f/image/upload/v1779193947/face-facts-mockup_j4rql4.webp";
...
export const StudioPipeline = () => {
  ...
  return (
    <section className="relative w-full bg-[#030303] py-24 md:py-32 px-4 sm:px-6 overflow-hidden border-t border-white/5 selection:bg-orange-500/20 selection:text-white">
      ...
      <div
        className="relative z-10 w-full max-w-[85rem] mx-auto flex flex-col items-center"
        ref={containerRef}
      >
        {/* ── HEADER ── */}
        <div className="text-center max-w-3xl mb-16 md:mb-24">
          ...
          >
            ...
            <p className="text-[#E5E5E5]/70 text-base md:text-xl font-medium leading-relaxed max-w-2xl mx-auto">
              We don't just animate a photo. We engineer a structured suite of
              cinematic video hooks and complementary static ads from a single
              input.
            </p>
          </motion.div>
        </div>
          ...
          <div className="w-full lg:w-[60%] flex flex-col">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 w-full">
              ...
              <div className="flex flex-col gap-4 md:gap-6">
                ...
                >
                  <video
                    src={optimizeMedia(OUTPUT_VIDEOS[0])}
                    autoPlay
                    muted
                    loop
                    playsInline
                ...
                >
                  <img
                    src={optimizeMedia(OUTPUT_STATICS[0])}
                    alt="Static Ad 1"
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent pointer-events-none" />
              ...
              <div className="flex flex-col gap-4 md:gap-6 md:mt-12">
                ...
                >
                  <img
                    src={optimizeMedia(OUTPUT_STATICS[1])}
                    alt="Static Ad 2"
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent pointer-events-none" />
                ...
                >
                  <video
                    src={optimizeMedia(OUTPUT_VIDEOS[1])}
                    autoPlay
                    muted
                    loop
                    playsInline
              ...
              <div className="flex flex-col gap-4 md:gap-6 col-span-2 md:col-span-1">
                ...
                >
                  <img
                    src={optimizeMedia(OUTPUT_STATICS[2])}
                    alt="Static Ad 3"
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent pointer-events-none" />
                ...
                <motion.div
                  ...
                  className="relative w-full aspect-[9/16] rounded-3xl overflow-hidden bg-[#0a0a0a] border border-white/10"
                >
                  <img
                    src={optimizeMedia(OUTPUT_STATICS[3])}
                    alt="Static Ad 4"
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent pointer-events-none" />
