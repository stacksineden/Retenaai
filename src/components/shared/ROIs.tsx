  ...
  const metrics = [
    {
      ...
      stat: "-85%",
      description:
        "Slash your creative budget. Get studio-grade assets without paying for model day-rates, location rentals, or logistical headaches.",
      icon: (
        <svg
    ...
    },
    {
      ...
      stat: "48hrs",
      description:
        "Turn a raw phone photo into a high-end, ready-to-launch campaign in two days. Skip the three-week studio editing queue.",
      icon: (
        <svg
          className="w-6 h-6 text-[#FCA311]"
          fill="none"
    ...
    },
    {
      ...
      stat: "3x",
      description:
        "Beat ad fatigue. Drastically lower your Cost Per Acquisition (CPA) on Meta and TikTok with fresh, scroll-stopping variations.",
      icon: (
        <svg
          className="w-6 h-6 text-[#FCA311]"
          fill="none"
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          <p className="text-[#E5E5E5] text-base md:text-xl max-w-2xl mx-auto opacity-80 leading-relaxed">
            Why DTC brands that live on Meta use RetenaAI to launch
            high-converting ad campaigns — faster, cheaper, and with better
            creative than the competition.
          </p>
        </div>
