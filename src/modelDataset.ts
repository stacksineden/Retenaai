...
export const packages = [
  {
    ...
    badge: "Best to Start",
    guarantee:
      "Not happy? We revise until you are — up to 3 rounds (most clients need one).",
    features: [
      "1 Ad Concept Delivered as 3 Video Hook Variants (15–30s, UGC or Cinematic)",
      "5 High-Fidelity Static Creatives",
      "Done-For-You Scripts & Copy",
      "Built to Test — 3 Openings, One Concept, Real Data",
      "48-Hour First Draft Delivery",
    ],
  },
  {
    name: "The Testing Sprint",
    slug: "testing_sprint",
    priceNGN: "₦1,050,000",
    priceUSD: "$750",
    amount: 1050000,
    ...
    badge: "Most Popular",
    guarantee:
      "Structurally different concepts — not the same ad in three outfits.",
    features: [
      "3 Distinct Ad Concepts (Different Angles, Formats & Messaging)",
      "9 Video Ads Total — 3 Hook Variants per Concept",
      "10 High-Fidelity Static Creatives",
      "Creative Testing Matrix — What to Run, Against What, and Why",
      "Done-For-You Scripts & Copy",
      "Delivered Over 2 Weeks, Ready for Meta & TikTok",
    ],
  },
  {
    name: "The Growth Retainer",
    slug: "growth_retainer",
    priceNGN: "From ₦2,100,000/mo",
    priceUSD: "From $1,500/mo",
    amount: null,
    highlight: false,
    badge: "Full Partnership",
    guarantee: "Cancel anytime. No lock-in.",
    features: [
      "4 New Ad Concepts per Month — 12–16 Video Variants Total",
      "20 Static Creatives per Month",
      "Monthly Creative Performance Review — We Iterate on What Wins",
      "Done-For-You Scripts & Copy",
...
// Internal downsell only — NOT displayed on the packages page.
// Offer in DMs when a prospect balks at the Campaign Pack price.
export const downsellPackages = [
  {
    ...
    guarantee:
      "Genuinely distinct creatives — not variations of the same concept.",
    features: [
...
export const pin_cat = [
  {
    ...
    hair_curler:[
       "https://res.cloudinary.com/dyryfgjro/image/upload/v1781594807/curlumi-ad3_w0ppoy.png",
       "https://res.cloudinary.com/dyryfgjro/image/upload/v1781594810/curlumi-ad5_uhuhlr.png",
