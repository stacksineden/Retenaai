...
export const packages = [
  {
    ...
    highlight: true,
    badge: "Best to Start",
    guarantee: "Not happy with the result? We revise until you are.",
    features: [
      "1 Ready-to-Launch Video Ad (15-30s, UGC or Cinematic)",
      "5 High-Fidelity Static Creatives",
  ...
  },
  {
    ...
    priceUSD: "Custom — Built Around Your Goals",
    amount: null,
    highlight: false,
